...
$category = $conn->query("SELECT * FROM `thumb`");
    ...
    <div class="container">
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="addNewArt.php">Add new arts</a></li>
            ...
            <div class="panel-body">
              <form action="Function.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label>Title</label>
                  <input type="text" class="form-control" name="title" placeholder="Artifact title" required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <br>
                  <select name="cat_id" id="Fcat" required> <?php foreach ($category as $row) { ?>
                ...
                <div class="form-group">
                  <input class="btn btn-default" name="submit-art" type="submit" value="submit">
                </div>
              </form>
            </div>
          </div>

    ...
    <div class="row">
      ...
      <div class="col-7">
        ...
        <section id="main" class="wrapper">
          <div class="inner">
            <div class="content">
            <span class="heading">Your Profile<span>

              <a href="updateProfile.php" style="float:right">update Profile</a>
              <br>
              <br>
              <label><strong>Username: </strong><?php echo $user['username']; ?></label>
              <hr>
              <label><strong>email: </strong><?php echo $user['email']; ?></label>
              <hr>
              <label><strong>Name: </strong><?php echo $user['name']; ?></label>
              <hr>
              <label><strong>Address:</strong> <?php echo $user['address']; ?></label>
            </div>
          </div>
